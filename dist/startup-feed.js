const paths = {
  ...
  message:'<path class="message-bubble" d="M12 3C6.5 3 2.5 6.3 2.5 10.8c0 2.5 1.3 4.6 3.5 6L5 21l5-2.6c.7.1 1.3.2 2 .2 5.5 0 9.5-3.3 9.5-7.8S17.5 3 12 3Z"/><g class="message-dots"><circle cx="8" cy="10.8" r="1.1"/><circle cx="12" cy="10.8" r="1.1"/><circle cx="16" cy="10.8" r="1.1"/></g>',
...
const tabs=[['home','Home','home'],['feed','Feed','feed'],['program','Program','program'],['agenda','My Agenda','clock'],['meetings','Meetings','people'],['map','Map','pin']];
